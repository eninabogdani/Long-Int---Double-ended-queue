...
// A Deque object contains the digits of a very long integer.
// The front item corresponds to the most significant digit.
// The tail items corresponds to the least significant digit.
